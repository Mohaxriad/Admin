...
import { userColumns, userRows } from "../sourcedata/datatablesource";
...
const Datatable = () => {
  ...
  return (
    <div className="h-[600px] p-[20px]">
      ...
      <h1 className="font-bold text-xl xl:text-2xl pb-2 "> Gestion des utillisateurs : </h1>
      ...
      <DataGrid
        className="datagrid sm:overflow-hidden sm:max-w-full overflow-x-auto flex flex-col md:flex-row  "
        rows={data}
